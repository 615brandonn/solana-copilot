  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard
        ...
        description="How much you commit per copy trade"
        icon={<DollarSign className="h-4 w-4" />}
      >
        <SettingRow
          label="Fixed buy amount"
          hint="Verified USD value of SOL sent into each swap. Network/Jito fees are additional, and the token's market value can move after purchase."
        >
          <NumInput
