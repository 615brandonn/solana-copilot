...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sub-second Solana copy trading. Mirror target wallets, monitor followers, and auto-exit with configurable risk controls." },
      { property: "og:title", content: "Helix — Solana Copy Trading Bot" },
      { property: "og:description", content: "Sub-second Solana copy trading with follower-wallet monitoring and Jito bundle execution." },
